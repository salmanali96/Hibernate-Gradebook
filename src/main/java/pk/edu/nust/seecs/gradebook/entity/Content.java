...
public class Content implements java.io.Serializable {
   ...
   /* public List<Clo> getClo() {
    ...
    public String toString() {
        return "Content{" + "contentId=" + contentId + ", title=" + title + ", description=" + description + ", starttime=" + starttime + ", endtime=" + endtime + ", students=" + students + ", course=" + course + ", grades=" + "" + ", clo=" + clo + '}';
    }
